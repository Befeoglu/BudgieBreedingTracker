    ...
    <div className="bg-white rounded-xl shadow-sm border border-neutral-200 overflow-hidden hover:shadow-md transition-all duration-300 transform hover:scale-[1.02] animate-fade-in">
      ...
      <div className="p-4">
        <div className="flex items-center justify-between mb-2">
          ...
          <span className={`text-lg font-bold ${genderColor}`}>{genderSymbol}</span>
        </div>
        
        <p className="text-sm text-neutral-600 mb-3 truncate">{species}</p>
        ...
        <div className="space-y-2">
          ...
          <div className="flex justify-between text-xs">
            ...
            <span className="text-neutral-700 font-medium truncate ml-2">{ring_number}</span>
          </div>
          
          {color_mutation && (
            <div className="flex justify-between text-xs">
              <span className="text-neutral-500">Renk:</span>
              <span className="text-neutral-700 font-medium truncate ml-2">{color_mutation}</span>
            </div>
          )}
        </div>
      </div>
  ...
  return (
    <div>
      ...
      <div className="flex items-center justify-between mb-6">
        <div>
          <h2 className="text-xl font-bold text-neutral-800">Kuşlarım</h2>
              ...
              {bulkSelectMode && (
                <div className="absolute top-2 left-2 z-10">
                  <input
                    ...
                    className="w-5 h-5 text-primary-600 bg-white border-2 border-white rounded focus:ring-primary-500"
                  />
                </div>
              )}
              <BirdCard
